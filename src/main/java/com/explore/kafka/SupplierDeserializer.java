...
public class SupplierDeserializer implements Deserializer<Dummy> {
    ...
    public Dummy deserialize(String topic, byte[] data) {
        ...
        try {
            if (data == null){
                System.out.println("Null recieved at deserializer");
                                return null;
                                }
            ...
            return new Dummy(id,deserializedName,df.parse(dateString));
